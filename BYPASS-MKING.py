...
"""
try:
    my = requests.get("https://github.com/AfghanHack001/BYPASS-MKING/blob/main/public.txt")
...
def mohammad():
  ...
  try:
    plr = requests.get('https://github.com/AfghanHack001/BYPASS-MKING/blob/main/public.txt').text
    if id in httpCaht:
